...
- NPM releases: assume login is already set up; publish may require the user’s 6-digit OTP or it will fail. Ask for the code rather than reading it from any store.
