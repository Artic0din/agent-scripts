...
| Workflow setup | claude-handoff, git-guardrails-claude-code, handoff, loop-me, migrate-to-shoehorn, scaffold-exercises, setup-matt-pocock-skills, setup-pre-commit, setup-ts-deep-modules |
