...
- **Human-only steps**: complete the authorized work available to the agent, then explain the exact remaining dashboard or credential step to the user without requesting secret values in chat.
  Do not invoke the withheld wizard; this import does not provide that workflow.
