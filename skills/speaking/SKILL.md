...
- **Strategy (read first, always): `~/Metisary/Enviroment/manager/CONFERENCES.md`** — standing decisions (e.g. no TED, no paid talks), 2027 budget, anchor plan, triage tiers.
